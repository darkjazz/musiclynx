...
export class ArtistService {
  ...
  getFeaturedArtists(): Promise<Artist[]> {
    return this.http
      .get(Config.server + Config.artist + "/get_featured_artists")
      .toPromise()
      .then((res: Response) => {
  ...
  constructMusicbrainzArtist(artist: Artist): Promise<Artist> {
    ...
    var params = `/${id}/${name}`;
    return this.http
      .get(Config.server + Config.artist + "/get_mb_artist" + params)
      .toPromise()
      .then((res: Response) => {
        return res.json() as Artist;
      })
  ...
  constructDbpediaArtist(artist: Artist): Promise<Artist> {
    ...
    return this.http
      .get(Config.server + Config.artist + "/get_dbp_artist" + params)
      .toPromise()
      .then((res: Response) => {
        return res.json() as Artist;
      })
  ...
  public getImage(id: string): Promise<Artist> {
    var param = `/${id}`;
    return this.http
      .get(Config.server + Config.wikidata + "/get_reduced_image" + param)
      .toPromise()
      .then((res: Response) => {
  ...
  public getAcousticbrainzLinks(artist: Artist): Promise<Category[]> {
    ...
    return this.http
      .get(
        Config.server + Config.artist + "/get_acousticbrainz_artists" + param,
      )
      .toPromise()
      .then((res: Response) => {
  ...
  public getMoodplayLinks(artist: Artist, limit: Number): Promise<Category> {
    var param = `/${artist.id}`;
    return this.http
      .get(Config.server + Config.artist + "/get_moodplay_artists" + param)
      .toPromise()
      .then((res: Response) => {
        return res.json() as Category;
      })
  ...
  public getLastFMLinks(artist: Artist): Promise<Category> {
    ...
    var params = `/${id}/${name}`;
    return this.http
      .get(Config.server + Config.lastfm + "/get_similar_artists" + params)
      .toPromise()
      .then((res: Response) => {
        var json = res.json();
